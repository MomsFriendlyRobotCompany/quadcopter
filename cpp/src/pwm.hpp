...
constexpr uint16_t SERVO_MAX_PULSE_WIDTH = 2000;
constexpr uint16_t SERVO_ZERO_PULSE_WIDTH = 1500;
constexpr uint16_t SERVO_MIN_PULSE_WIDTH = 1000;
constexpr uint16_t PWM_PERIOD_us = 20*1000UL;
...
class Servo {
  ...
  void init(const uint pwm_pin,
            uint16_t max_pwm_us=SERVO_MAX_PULSE_WIDTH,
